package com.ilop.architecture.utils;
...
public final class NetworkUtils {
    ...
    public static boolean is5GHzWiFi(){
        WifiInfo mWifiInfo = getWiFiInfo();
        if (mWifiInfo == null) return false;
     ...
     * @return enable
     */
    public static boolean isCurrentNoNet() {
    ...
    public static WifiInfo getWiFiInfo() {
        @SuppressLint("WifiManagerLeak")
        WifiManager mManager = (WifiManager) Utils.getApp().getSystemService(Context.WIFI_SERVICE);
    ...
    public static boolean isNetworkError(NetworkType type) {
        return type == NetworkType.NETWORK_UNKNOWN || type == NetworkType.NETWORK_NO;
    }

    public static boolean isDataFlow(NetworkType type) {
